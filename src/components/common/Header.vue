    ...
    <div class="header">
        ...
        <!-- <el-dialog title="修改登录密码" :visible.sync="changePassDialog" :close-on-click-modal="false">
            ...
            <el-form>
                ...
                <div class="m-b-10 red">
                    为了账号安全，修改成功后将退出登录
                </div>
                <el-button type="primary" @click="changePassword" :loading="newPass.loading" :disabled="newPass.disabled">保存</el-button>
            </el-form>
        </el-dialog> -->
    </div>
</template>
...
export default {
    ...
    methods: {
        changePassword(){
            ...
            // this.ax.post("user/manager/pass",{password:this.newPass.pass1}).then(it =>{
